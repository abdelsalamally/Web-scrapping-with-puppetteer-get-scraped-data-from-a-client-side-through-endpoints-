...
const BASE_URL = 'https://trustjuris.com/services/';
...
const trust = {
    ...
    initialize: async()=>{
      ...
      // await trust.page.waitFor(3000);
       ...
       const Services = await trust.page.evaluate(() => document.querySelector('.et_pb_section.et_pb_section_1.et_section_regular').innerText);
